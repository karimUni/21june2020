...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='quiz_class', to='User.ClassRoom'),
        ),
        migrations.AddField(
            model_name='quiz',
            name='quiz_questions',
            field=models.ManyToManyField(related_name='quiz_questions', to='Question.Question'),
        ),
        migrations.AddField(
            model_name='quiz',
            name='quiz_subject',
        ...
        migrations.AddField(
            model_name='answers',
            name='answers_quiz',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quiz_answers', to='Quiz.Quiz'),
        ),
    ]
